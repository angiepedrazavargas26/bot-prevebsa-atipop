    ...
    if (AGENTES.includes(phone)) {
      ...
      if (text === '#bot') {
        ...
        if (cliente) {
          ...
          await sendWhatsApp(phone, '⚠️ No tiene ningún caso activo.');
        }
        return;
      }
